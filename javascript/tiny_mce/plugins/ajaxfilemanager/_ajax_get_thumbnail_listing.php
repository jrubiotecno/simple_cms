...
<?php 
		...
		
		{
			...
			<dl class="thumbnailListing" id="dl<?php echo $count; ?>">
				...
				<dd id="dd<?php echo $count; ?>" class="thumbnailListing_info"><span id="flag<?php echo $count; ?>" class="<?php echo $file['flag']; ?>">&nbsp;</span><input id="cb<?php echo $count; ?>" type="checkbox" name="check[]" class="radio" value="<?php echo $file['path']; ?>" />
