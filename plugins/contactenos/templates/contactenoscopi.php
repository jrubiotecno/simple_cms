<div class="titulo">
	...
	<p>
		...
		<br />
		Solicitud de información: info@hbp.net.co
		<br />

		Ventas: ventas@hbp.net.co
		<br />
		Bogotá, Colombia
		</b>
	</p>
	...
	<form action="index.php?page=contactenos" method="post" id="contactform">
		<ol>
			...
			<li>
				...
				<input id="nit" name="nit" class="text validate[required]">
			</li>
			<li>
				<label for="apellidos">
					NUMERO DE PERSONAS EN LA EMPRESA:
				</label>
				<input id="numpersonas" name="numpersonas" class="text validate[required]">
			</li>
			<li>
				<label for="apellidos">
					CARGO:
			...
			<li>
				...
				<input id="telefono" name="telefono" class="text validate[required]">
			</li>
			<li>
				<label for="message">
					COMENTARIOS:
